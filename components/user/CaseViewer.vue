<template>
  <div>
    <!-- PDFボタン用の独立したコンテナ -->
    <div class="pdf-buttons mb-4" style="display: flex; justify-content: flex-end; margin: 5mm;">
      <v-btn
        variant="outlined"
        color="primary"
        class="preview-btn"
...
import CasePreview from '~/components/preview/CasePreview.vue'
